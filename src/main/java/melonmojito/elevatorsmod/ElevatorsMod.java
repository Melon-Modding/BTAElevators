...
//	}
    ...
    public void onInitialize() {
		...
		Block.blocksList[437] = new ElevatorBlock ("block.steel", 437, Material.metal).withTexCoords(19, 4, 19, 6, 19, 5).withHardness(5.0F).withBlastResistance(2000.0F).withTags(BlockTags.MINEABLE_BY_PICKAXE);
    }
}
